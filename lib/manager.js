...
export default class Manager {
  ...
  scan() {
    ...
    const updateClient = function(client) {
      ...
      if (!this._clientRefs[client.ref])
        this._clientRefs[client.ref] = this.hashCode(JSON.stringify(client.serialize()))

      var ref = this.hashCode(JSON.stringify(client.serialize()))

      if (this._clientRefs[client.ref] === ref)
        return

      this._opts.onClientState(client.serialize())
